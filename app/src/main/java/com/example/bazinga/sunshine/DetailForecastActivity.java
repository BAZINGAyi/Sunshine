...
import com.example.bazinga.sunshine.databinding.ActivityDetailForecastBinding;
...
public class DetailForecastActivity extends AppCompatActivity implements
...
//  COMPLETED (3) Declare an ActivityDetailBinding field called mDetailBinding
    // the  name same as xml
    private ActivityDetailForecastBinding mDetailBinding;
...
//      COMPLETED (6) Instantiate mDetailBinding using DataBindingUtil
        mDetailBinding = DataBindingUtil.setContentView(this, R.layout.activity_detail_forecast);
